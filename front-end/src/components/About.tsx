  ...
  return (
    <div className='flex flex-col items-center bg-[#06130e] pt-16 h-screen overflow-hidden pl-[3.8vw]'>
        ...
        <div className='flex flex-row w-full mt-10 relative'>
            <div className='lg:w-1/2 flex flex-col gap-8 text-base lg:text-[24px] mt-8 text-white satoshi px-6 md:px-0'>
            ...
            <img src={guy} alt='Laptop' className='absolute right-0 h-[600px] hidden lg:flex' />
